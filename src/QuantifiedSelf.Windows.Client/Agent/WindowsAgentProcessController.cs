...
namespace QuantifiedSelf.Windows.Client.Agent;

public sealed class WindowsAgentProcessController : IAgentProcessController
{
    private readonly WindowsAgentPaths _paths;
    private readonly RuntimeStateStore _runtimeStateStore;
    private readonly ILogger<WindowsAgentProcessController> _logger;
    private readonly bool _showAgentConsole;
    private readonly RuntimeChannel _runtimeChannel;

    public WindowsAgentProcessController(
        WindowsAgentPaths paths,
        RuntimeStateStore runtimeStateStore,
        ILogger<WindowsAgentProcessController> logger,
